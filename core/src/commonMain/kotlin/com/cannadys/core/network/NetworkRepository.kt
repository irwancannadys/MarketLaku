...
import com.cannadys.core.exception.InternalException
import org.example.core.exception.NetworkException
...
abstract class NetworkRepository {
    ...
    protected inline fun <reified T, U>(suspend () -> HttpResponse).reduce(
        ...
        return flow {
            ...
            val state = Async.Failure(NetworkException(it.message))
            emit(state)
        }
    }
}